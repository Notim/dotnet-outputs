...
public class MessageNullOrEmptyExceptionTests    
{
    [Fact]
    public void Constructor_Default_ShouldCreateInstance()
    {
        // Arrange & Act
        var exception = new MessageNullOrEmptyException();
    ...
    public void Constructor_WithMessage_ShouldCreateInstanceWithMessage()
    {
        ...
        // Act
        var exception = new MessageNullOrEmptyException(message);
    ...
    public void Constructor_WithMessageAndInnerException_ShouldCreateInstanceWithMessageAndInnerException()
    {
        ...
        // Act
        var exception = new MessageNullOrEmptyException(message, innerException);
