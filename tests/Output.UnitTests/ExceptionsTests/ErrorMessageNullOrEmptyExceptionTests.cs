...
public class ErrorMessageNullOrEmptyExceptionTests    
{
    [Fact]
    public void Constructor_Default_ShouldCreateInstance()
    {
        // Arrange & Act
        var exception = new ErrorMessageNullOrEmptyException();
    ...
    public void Constructor_WithMessage_ShouldCreateInstanceWithMessage()
    {
        ...
        // Act
        var exception = new ErrorMessageNullOrEmptyException(message);
    ...
    public void Constructor_WithMessageAndInnerException_ShouldCreateInstanceWithMessageAndInnerException()
    {
        ...
        // Act
        var exception = new ErrorMessageNullOrEmptyException(message, innerException);
